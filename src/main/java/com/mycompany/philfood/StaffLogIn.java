...
public class StaffLogIn extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            ...
            // search for the username and password in the file
            ...
            // display an appropriate message based on the outcome of the login attempt
            if (found) {
                try {
                    ...
                    if (lastLine == null || !lastLine.endsWith(",")) { // check if the last line ends with a comma
                        writer.write(name+","+currentTime + ","); // write current time followed by a comma in the first row
                    } else {
                        writer.write("\n" + name+","+currentTime + ","); // write current time in a new line followed by a comma in the second row
                    }
                    writer.close();
